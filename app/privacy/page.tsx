...
export const metadata: Metadata = {
  title: 'Privacy Policy - Boondoggling.ai',
  description: 'Privacy policy for Boondoggling.ai',
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              Welcome to <strong>boondoggling.ai</strong>, operated by <strong>Boondoggling.ai</strong>. We are committed to protecting your
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              website, express an interest in obtaining information about us or our services, participate
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              <li><strong>Engagement Data:</strong> When engaging our services, we may collect business information, account requirements, and related professional details as governed by separate agreements.</li>
            </ul>
            <p className="mt-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              <li>To deliver services you have engaged</li>
          ...
          <section className="mb-8">
            ...
            <p className="mt-4">
              We encourage you to review the privacy policies of these third-party services. Boondoggling.ai is not
          ...
          <section className="mb-8">
            ...
            <p>
              If you have questions or comments about this privacy policy, please contact Boondoggling.ai:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>
