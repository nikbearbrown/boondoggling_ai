...
export const metadata: Metadata = {
  title: 'Cookie Policy - Boondoggling.ai',
  description: 'Cookie policy for Boondoggling.ai',
}
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              ...
              This Cookie Policy explains how <strong>Boondoggling.ai</strong> uses cookies and similar technologies on{' '}
              <strong>boondoggling.ai</strong>.
            </p>
          ...
          <section className="mb-8">
            ...
            <p>
              If you have questions about our use of cookies, please contact Boondoggling.ai:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>
