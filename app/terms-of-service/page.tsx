...
export const metadata: Metadata = {
  title: 'Terms of Service - Boondoggling.ai',
  description: 'Terms of Service for Boondoggling.ai',
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              Welcome to <strong>boondoggling.ai</strong>. By accessing or using this website, you agree to be bound by
            ...
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Company:</strong> Boondoggling.ai</li>
          ...
          <section className="mb-8">
            ...
            <p>
              Boondoggling.ai provides AI tools, educational content, and curated resources. The boondoggling.ai website serves as an informational resource, tool directory,
          ...
          <section className="mb-8">
            ...
            <p>
              Boondoggling.ai offers AI tools, educational resources, and curated content. All engagements are governed by
              separate agreements between Boondoggling.ai and the participant. These Terms apply to use of this
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              and software, is the property of Boondoggling.ai or its content suppliers and is protected by
          ...
          <section className="mb-8">
            ...
            <p className="mt-4">
              ...
              by Boondoggling.ai at any time.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              Boondoggling.ai. These articles are provided for convenient reading and are attributed to their original
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              GitHub, Vercel, Neon, and Anthropic. Boondoggling.ai does not guarantee the accuracy,
              relevance, timeliness, or completeness of any information on these external services. Please note that
              Boondoggling.ai is not responsible for the content, privacy practices, or availability of these external
          ...
          <section className="mb-8">
            ...
            <p>
              The materials on Boondoggling.ai&apos;s website are provided &ldquo;as is&rdquo; and &ldquo;as available.&rdquo;
              Boondoggling.ai makes no warranties, expressed or implied, and hereby disclaims and negates all other
            ...
            <p className="mt-4">
              ...
              Boondoggling.ai does not warrant that the website will be uninterrupted, error-free, or free of harmful
              components.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              In no event shall Boondoggling.ai or its partners be liable for any damages (including, without
              limitation, damages for loss of data or profit, or due to business interruption) arising out of the use
              or inability to use the materials on this website, even if Boondoggling.ai or an authorised representative
          ...
          <section className="mb-8">
            ...
            <p>
              You agree to indemnify and hold harmless Boondoggling.ai, its partners, and its affiliates from any
          ...
          <section className="mb-8">
            ...
            <p>
              The materials appearing on Boondoggling.ai&apos;s website could include technical, typographical, or
              photographic errors. Boondoggling.ai does not warrant that any of the materials on its website are accurate,
              complete, or current. Boondoggling.ai may make changes to the materials contained on its website at any time
              without notice.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Boondoggling.ai may revise these Terms of Service at any time without notice. By using this website, you
          ...
          <section className="mb-8">
            ...
            <p>
              If you have any questions about these Terms, please contact Boondoggling.ai:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>
